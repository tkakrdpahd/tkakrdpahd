...
HONORS AND SCHOLARSHIPS_____________________________________________________
...
GRANTS_______________________________________________________________________________

Future artist award, YOUNGEUN MUSEUM, Gyeonggi-do, South Korea, January 6th, 2020.

MEMBERSHIPS_______________________________________________________________________

Korean Game Society: Associate Member

Digital Contents Society: Associate Member

Korean Society for Computer Game: Associate Member

American Educational Research Association: AERA Member ID; 1082395

PUBLICATIONS_______________________________________________________________________

M. Doo (Not published yet). Unearthing the Essence of Video Games: An Analysis of Literary and Artistic Discourses. Semiotica: Journal of the International Association for Semiotic Studies. 

CONFERENCE PRESENTATIONS AND PUBLICATIONS _________________________

M. Doo (2024). V-Tuber Wave: Origins, Divergence, and Convergence in Contemporary Media. Global Conference on Media, Communication, and Film (MCFCONF). 2024 conference.

M. Doo. (2023). Tactic of Game Design: The Playability and Gameness. Korea Game Society (한국게임학회). 2023 Spring conference. 3-10.

PROJECT EXPERIENCE______________________________________________________________

Internship (2024 summer)

Perception Neuron, Technical Art

	Technical art internship with motion capture studio.

V-Tuber Project 2024 (2024 Spring - 2024 Winter)
...
Software: Adobe Photoshop CS3 - CC, Maya, ZBrush 2021 - 2023, Substance Painter, Unreal Engine 4

Programming Languages: C, C++

Operating Systems: Windows, Ubuntu, Debian, Rocky_9

Network Management: TCP/IP engineering, FTP, ILS (Windows), Ubuntu Server

DB Systems: MariaDB, MySQL, PHP
...
Software: DaVinci Resolve, Clip Studio

Programming Languages: React

Operating Systems: Arch

LANGUAGES___________________________________________________________________________

Fluent in Korean – Native Speaker
